...
<nav>
  <ul>
    <li>
      <a data-sveltekit-prefetch href="/" aria-current={$page.url.pathname === '/'}
    ...
    <li>
      <a href="/patrimony" aria-current={$page.url.pathname === '/patrimony'}
        ><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
          <path
          ...
          />
        </svg><span>Patrimony</span></a
      >
    </li>
    <li>
      <a href="/transactions/containers/1" aria-current={/containers/.test($page.url.pathname)}
        ><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
          <path
          ...
          />
        </svg><span>Containers</span></a
      >
    </li>
    <li>
      <a data-sveltekit-prefetch href="/admin" aria-current={$page.url.pathname === '/admin'}
        ><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
          <path
...
<style>
  ...
  a {
    ...
    transition: padding var(--animation-delay) var(--animation-timing);
  }
